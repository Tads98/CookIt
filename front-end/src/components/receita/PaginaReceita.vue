      ...
      <div id="dados-receita-completa">
        <div class="row">
          <div id="titulo-receita-completa" class="col">
            <h3>{{ ingredientes.nome_receita }}</h3>
            <p>
              publicado por <strong>{{ ingredientes.dono_receita }}</strong>
            </p>
            <div>
        ...
        <div class="col-md">
              ...
              <div id="icones-receita-completa" class="col">
                ...
                >
                  <div class="icon-text-receita-completa">
                    ...
                    <br />
                    {% if ingredientes.tempo_preparo %}
                    <p>
                      {{ ingredientes.tempo_preparo }}
                      {{ ingredientes.get_tempo_unidade_medida_display
                      }}{{ ingredientes.tempo_preparo | pluralize }}
                    </p>
                    {% endif %}
                  </div>
                </div>
                ...
                <div class="col line-receita-completa">
                  <div class="icon-text-receita-completa">
                    ...
                    <br />
                    {% if ingredientes.porcoes %}
                    <p>
                      Por{{ingredientes.porcoes}}:
                ...
                <div class="col line-receita-completa">
                  <div class="icon-text-receita-completa">
                    ...
                    <br />
                    <p>
                      Dificuldade: {{ ingredientes.get_dificuldade_display }}
                    </p>
                  </div>
                </div>
                ...
                <div class="col line-receita-completa">
                  <div class="icon-text-receita-completa">
                    ...
                    <br />
                    <p>{{ ingredientes.data_publicacao | date }}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-3">
            <div id="ingredientes-receita-completa" class="col">
              <h3>
                Ingredientes ({{ ingredientes.ingredientes.all | length }})
              </h3>

              <div id="alinhamento-ingredientes">
                {% for ingrediente in ingredientes.ingredientes.all %} {%if
                ingrediente.unidade_medida == 'AGS' %}
                <p>
                  <strong style="color: #f0a916">{{
                    ingrediente.nome_ingrediente
                  }}</strong>
                  <strong>{{ ingrediente.get_unidade_medida_display }}</strong>
                </p>
                {%else%}
                <p>
                  <strong
                    >{{ ingrediente.quantidade }}
                    {{ ingrediente.get_unidade_medida_display }}</strong
                  >
                  de
                  <strong style="color: #f0a916">{{
                    ingrediente.nome_ingrediente
            ...
            <div class="col">
              ...
              <div id="usuario-receita-completa">
                <div id="dados-usuario-receita-completa" class="row">
                  ...
                  <div class="col">
                    <h4>{{ ingrediente.dono_receita }}</h4>
                    <p>
