# Generated by Django 3.1.2 on 2020-12-14 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidade_medida', models.CharField(choices=[('U', 'Unidade'), ('X', 'Xícara'), ('C', 'Colher de Sopa'), ('CH', 'Colher de Chá'), ('D', 'Dente de Alho'), ('M', 'Mililitro(ml)'), ('L', 'Litros'), ('G', 'Gramas(g)'), ('KG', 'Quilograma(kg)'), ('AGS', 'ao gosto')], default='U', max_length=3)),
